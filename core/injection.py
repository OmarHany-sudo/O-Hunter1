...
# ============================================
# Aliases for compatibility with scanner.py
# ============================================

class SQLInjectionChecker(InjectionScanner):
    def __init__(self):
        super().__init__()
...
class XSSChecker:
    ...
    def check_xss(self, target_url, param_name):
            ...
            try:
                ...
                if payload in response.text:
                    self.findings.append({
                        ...
                        'remediation': 'Properly sanitize and encode user input before rendering in the browser.'
                    })
                    return
            except requests.exceptions.RequestException as e:
